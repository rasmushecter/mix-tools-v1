...
public class TripletBpmEntity {
    ...
    public TripletBpmEntity() {
    }

    public TripletBpmEntity(double wholeNote, double halfNote, double fourthNote, double eightNote, double sixteenNote, double thertyTwoNote, double sixtyfourNote) {
